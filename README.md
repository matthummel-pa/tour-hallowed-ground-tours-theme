...
No bundler. No framework runtime. Open a file or any static server. Headings use self-hosted **Archivo Black** (heavy display sans). UI is **Atkinson Hyperlegible**. Labels are **IBM Plex Mono**.
